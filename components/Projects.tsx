          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 z-0">
                ...
                <div className="absolute inset-0 bg-neutral-950/80 group-hover:bg-neutral-950/30 transition-colors duration-500 z-10" />
              ...
              <div className="absolute inset-0 z-20 p-8 flex flex-col justify-between">
                ...
                <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                  <div className="overflow-hidden mb-2">
                    <h3 className="text-3xl font-black text-white uppercase tracking-tight leading-none transform translate-y-full group-hover:translate-y-0 transition-transform duration-500 delay-100 drop-shadow-lg">
                      {project.title}
                    </h3>
                  </div>
                  ...
                  <div className="absolute bottom-0 right-0 p-4 opacity-0 group-hover:opacity-100 transition-opacity delay-300">
